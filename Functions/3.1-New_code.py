...
# S2_dir = Path(r"C:\Users\zkhalid5\OneDrive - George Mason University - O365 Production\Documents\ArcGIS\Projects\HydroDEM - Tool Run\step2\RUN")
# S3_dir = Path(r"C:\Users\zkhalid5\OneDrive - George Mason University - O365 Production\Documents\ArcGIS\Projects\HydroDEM - Tool Run\step3")
# S3_roads_buffer = Path(S3_dir / "S3_road_buffer.shp")
...
output_dir = Path(r"C:\Users\zkhalid5\OneDrive - George Mason University - O365 Production\Documents\ArcGIS\Projects\HydroDEM - Tool Run\step3\RUN2") # output directory     (OUTPUT)



s2_result_path = output_dir / "S2_result73.shp"
s2_result = gpd.read_file(s2_result_path)
obs_points = s2_result[s2_result['obstructio'] == 1]
